---
title: "Developing Applications with SQL, Databases, and Django Week 1"
image: "cover.png"
date: 2023-03-28T22:28:05Z
lastmod: 2023-03-28T22:28:06Z
...
Database: Repository, tables Data Management System: software to manage database Relational Data Management System: a set of software to manage database
...
A relational database is a collection of data organized into a table structure, where the tables can be linked, or related, based on data common to each. Rows are the record and columns are the attributes. Similarities between relational databased and spreadsheets: Relational databased build on the organizational principles of flat files such as spreadsheets, with data organized into rows and columns following a well-defined structure and schema. Relational databased:
...
IBM DB2, MySQL, Oracle database, PostgreSQL Cloud-based relational databased or database-as-a-service: Amazon RDS, Google SQL, IBM DB2 on Cloud, Oracle Cloud, Azure SQL Advantages of Relational Databases:
...
Primary key and foreign key Primary key is used to uniquely identified a specific row in a table Common datatypes include characters, numbers, and dates/times
...
Object-oriented paradigm executing SQL in Python
