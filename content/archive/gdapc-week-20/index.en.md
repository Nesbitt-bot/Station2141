...
## <a id="_b960pdj8scnj"></a>__Sorting versus filtering__

__![Left image of a pair of hands sorting letters and numbers. Right image is a hand holding a filter sorting numbers and letters](image-1.png)__
...
Syntax: =SORT\(form:to,colum\_number,A TRUE statement is in ascending order, and FALSE is descending\)\.
...
# <a id="_ixmfnnogk23j"></a>Sorting and filtering in Sheets and Excel
...
## <a id="_5xjlng7em9cd"></a>__Sorting and filtering in Sheets__
...
## <a id="_provga7xczkm"></a>__Sorting and filtering in Excel__
