...
image: "cover.png"
description: "Three questions to clear out your concern: You might remember that stakeholders are people who have invested time, interest, and resources into the projects…"
tags: ["GDAPC","Google Data Analytics","Coursera","Week 9"]
...
Three questions to clear out your concern:

1. Who are the primary (who make decisions based on data) and secondary (who rely on your task to get better performance) stakeholders?
2. Who is managing the data? (spending your time effectively)
3. Where can you go for help? (project manager in common)
...
![This is an image of a woman standing on a stage in front of a microphone](image-1.png)
...
![This is an image of 3 professionals sitting around a table with a white board in the background](image-2.png)
...
![Venn diagram with three overlapping circles: Mathematics and statistics, Computer science, and Business domain knowledge](image-3.png)
...
![Image of two people sitting at a desk. One of them is on a laptop and the other is holding a coffee mug](image-4.png)
...
![The illustration shows the first icon with the question: who is your audience?](image-5.png)

 Kiri, Product Development Project Manager

![The illustration shows the second icon with the question: what do they already know?](image-6.png)
...
![The illustration shows the third icon with the question: what do they need to know?](image-7.png)
...
![The illustration shows the fourth and final icon with the question: how can you best communicate what they need to know?](image-8.png)
...
![This Illustration shows a sample email that addresses the four audience questions introduced with the four icons.](image-9.png)
...
![This illustration shows a sample email updating the released status of an analysis report.](image-10.png)
...
__very effective when you try to compose an email to your professor. lol__
...
![This illustration shows a question mark icon with the topic: The case of incomplete (or nonexistent) data.](image-11.png)
...
![This illustration shows a horizontal double-sided arrow icon with the topic: Don’t miss misaligned data.](image-12.png)
...
![This illustration shows a broom icon with the topic: Deal with dirty data.](image-13.png)
...
![This illustration shows a magnifying glass icon with the topic: Tell a clear story.](image-14.png)
...
![This illustration shows a mallet icon with the topic: Be the judge.](image-15.png)
...
![A group of co-workers sitting in a meeting room. A person is standing pointing at a presentation board](image-16.png)
...
![This illustration is a sample meeting agenda that includes sections for Goals, Questions, and Next Steps.](image-17.png)
