...
image: "cover.png"
description: "Tableau: A business intelligence and analytics platform that helps people see, understand, and make decisions with data."
tags: ["GDAPC","Google Data Analytics","Coursera","Week 25"]
...
![screenshot of the Create a Profile menu on Tableau Public](image-1.png)
...
![screenshot of the Tableau Public menu](image-2.png)
...
![These are side-by-side examples of a grouped column chart and two stacked column charts with 2 and 3 categories, respectively](image-3.png)
...
![These are side-by-side examples of a single line chart and a stacked line chart.](image-4.png)

- Pie: a pie chart is an easy way to visualize what proportion of the whole each data point represents.

![This is an example of a pie chart with four unequal pie sections in different shades of blue](image-5.png)

- Horizontal bar: a bar chart functions similarly to a column chart, but is flipped horizontally.

![This is an example of a grouped horizontal bar chart with two categories of data.](image-6.png)

- Area: area charts allow you to track changes in value across multiple categories of data.

![This is an example of a stacked area chart with two area charts for comparison.](image-7.png)

- Scatter: scatter plots are typically used to display trends in numeric data.

![This is an example of a scatter chart with x,y values plotted.](image-8.png)
...
![This is a combo chart with a line chart superimposed on a column chart.](image-9.png)
