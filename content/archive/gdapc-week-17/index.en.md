...
Typecasting: changing data typr from one to the other.

CAST(data AS type)

CONCAT(data_a,data_b) AS data_c

COALESCE(data_a, data_b) AS data_c (when data_a is null, data_c would be data_b)
