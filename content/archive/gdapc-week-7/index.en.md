...
image: "cover.png"
description: "Google Data Analytics Professional Certificate — Week 7 notes."
tags: ["GDAPC","Google Data Analytics","Coursera","Week 7"]
categories: ["Google data analytics professional certificates"]
draft: false
---

<a id="_3fs96by7s1lm"></a>Week 7

Quantitative data

Qualitative data

## <a id="_ktv3gflzon7r"></a>The beauty of dashboards
...
## <a id="_ssrh92qb1ylk"></a>Creating a dashboard
...
![This illustration shows four chart types clockwise from the top left: Line, Bar, Donut, and Pie.](image-1.png)
